...
exports.getAttributeString = function(attributeType) {
    for (var prop in homeeEnums.CAAttributeType) {
       if (attributeType === homeeEnums.CAAttributeType[prop]) {
           return prop.replace("CAAttributeType", "");;
       }
    }
